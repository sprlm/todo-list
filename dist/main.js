...
const initializeDOM = () => {
  ...
  const sample = new _Todo__WEBPACK_IMPORTED_MODULE_2__["default"]('Sample Todo (Click me!)','Hello! This is a sample description.','01/01/2030','normal');
  addTodoToDOM(sample);
