...
const addTodoFormToDOM = () => {
  ...
  todoFormBtn.addEventListener('click', (e) => {
    if (todoForm.checkValidity() == false) {
      ...
      const dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(
        (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todoForm.elements[2].value, 'yyyy-MM-dd', new Date()),
        'MM/dd/yyyy'
        );
...
const initializeDOM = () => {
  ...
  const test1 = new _Todo__WEBPACK_IMPORTED_MODULE_1__["default"]('title1','description','1/1/2022','normal');
  const test2 = new _Todo__WEBPACK_IMPORTED_MODULE_1__["default"]('title2','description','1/1/2022','high');
  const test3 = new _Todo__WEBPACK_IMPORTED_MODULE_1__["default"]('title3','description','1/1/2022','normal');
  addTodoToDOM(test1);
  addTodoToDOM(test2);
  addTodoToDOM(test3);
  logic.addTodo(test1);
